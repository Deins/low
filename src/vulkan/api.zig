...
pub const PfnGetPhysicalDeviceWaylandPresentationSupportKHR = *const fn (PhysicalDevice, u32, *anyopaque) callconv(call_conv) Bool32;
pub const PfnGetPhysicalDeviceWin32PresentationSupportKHR = *const fn (PhysicalDevice, u32) callconv(call_conv) Bool32;
pub const PfnGetPhysicalDeviceXlibPresentationSupportKHR = *const fn (PhysicalDevice, u32, *anyopaque, c_ulong) callconv(call_conv) Bool32;
